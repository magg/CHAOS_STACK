...
public interface Infrastructure {
	...
	/**
	 * Finds a security group with the given name, that can be applied to the
	 * given instance.
	 *
	 * For example, if it is a VPC instance, it makes sure that it is in the
	 * same VPC group.
	 *
	 * @param instanceId
	...
	/**
	 * Creates an (empty) security group, that can be applied to the given
	 * instance.
	 *
	 * @param instanceId
	 ...
	 *             if the instance no longer exists or was already terminated
	 *             after the crawler discovered it then you should get a
	 *             NotFoundException
	 */
	void setInstanceSecurityGroups(String instanceId, List<String> groupIds);

	SSHClient connectSsh(String instanceId);
